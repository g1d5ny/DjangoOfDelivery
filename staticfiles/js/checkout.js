$(function () {
    ...
    IMP.init('imp91147611'); //iamport 관리자 페이지에 있는 가맹점 식별코드
    $('.order-form').on('submit', function (e) { //order_form에 submit 버튼을 눌렀을 때 function 실행
...
function AjaxCreateOrder(e) {
    ...
    var request = $.ajax({
        ...
        data: $('.order-form').serialize() // serialize()를 통해 form의 객체들을 한번에 가공
    });
