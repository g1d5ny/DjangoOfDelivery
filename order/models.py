...
class Order(models.Model):
    ...
    point = models.ForeignKey(Point, on_delete=models.PROTECT, related_name='order_point', null=True, blank=True)
...
def order_payment_validation(sender, instance, created, *args, **kwargs):
    if instance.transaction_id:
        ...
        local_transaction = OrderTransaction.objects.fileter(merchant_order_id=merchant_order_id, transaction_id=imp_id,
